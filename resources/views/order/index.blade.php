        ...
        <div class="tile">
          ...
          <form method="" action="" class="my-3">
            <div class="form-row">
              ...
              <div class="col-md-4">
                <label></label>
                <input type="submit" name="btnsubmit" value="Search" class="btn btn-primary mt-4 searchdate">
              </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{route('order.show',$row->id)}}" class="btn btn-primary">Detail</a>
                       <form action="{{route('order.destroy',$row->id)}}" class="d-inline-block" method="POST" onsubmit="
